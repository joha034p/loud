    ...
    <div class="inner-wrap footer-wrapper">
        ...
        <div>
            ...
            <ul>
                ...
                <li>
                    <div class="smuktekst"> Wildersgade 10B, 2. sal </div>
                </li>
                <li>
                    <div class="smuktekst"> 1408 København </div>
                </li>
                <li>NYHEDSREDAKTION</li>
                <li>
                    <div class="smuktekst"> Vestergade 165D, 2. sal</div>
                </li>
                <li>
                    <div class="smuktekst"> 5700 Svendborg</div>
                </li>
